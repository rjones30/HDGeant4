...
msg << "G4ChordFinder::FindNextChord calls G4MagIntegration_Driver::QuickAdvance with stepTrial=" << stepTrial
    << ", stepMax=" << stepMax << ", fLastStepEst_U=" << fLastStepEstimate_Unconstrained;
     fIntgrDriver->QuickAdvance( yCurrent, dydx, stepTrial, 
                                 dChordStep, dyErrPos);
msg << " returns with dChordStep=" << dChordStep;
...
msg2 << "G4ChordFinder::NewStep(stepTrial=" << stepTrial << ",dChordStep=" << dChordStep
     << ", newStepEst_U=" << newStepEst_Uncons << ")";
     stepForChord = NewStep(stepTrial, dChordStep, newStepEst_Uncons );
msg2 << " returns dChordStep=" << dChordStep
     << ", newStepEst_U=" << newStepEst_Uncons;
...
std::stringstream msg;
msg << "G4ChordFinder::FindNextChord changes fLastStepEstimate_Unconstrained to " << fLastStepEstimate_Unconstrained;
GlueXUserEventInformation::Dlog(msg.str());
  }
