...
msg << "G4ParameterisedNavigation::LevelLocate changes " << pPhysical->GetName() << " to " << pPhysical->GetName() << ":" << replicaNo;
...
msg << " and assigns solid " << pSolid->GetName() << " to logical " << pLogical->GetName();
msg << " and swaps material " << ((pLogical->GetMaterial())? pLogical->GetMaterial()->GetName() : "NULL");
        pLogical->SetSolid(pSolid);
        pLogical->UpdateMaterial(pParam->ComputeMaterial(replicaNo,
                                 pPhysical, &parentTouchable)  );
msg << " for " << ((pLogical->GetMaterial())? pLogical->GetMaterial()->GetName() : "NULL");
